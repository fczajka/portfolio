...
export default function Project({
    ...
    return (
        <>
            <div
                ref={containerRef}
                className={`flex flex-col basis-1/3 max-w-sm mx-auto my-6 p-4 shadow-custom shadow-zinc-400 rounded-primary opacity-0 transition-all hover:scale-105 hover:opacity-100 hover:[animation-fill-mode:backwards] sm:p-6 ${

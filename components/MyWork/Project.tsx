        ...
        <>
            ...
            >
                ...
                <button
                    ...
                    className={`absolute right-6 bottom-4 bg-blue-200 text-right px-4 py-2 rounded-full ${lilitaOne.variable} font-lilita-one hover:animate-button-background hover:motion-reduce:animate-none hover:motion-reduce:[boxShadow:4px_6px_#e4e4e7]`}
                >
                    Read more
                </button>
            </div>

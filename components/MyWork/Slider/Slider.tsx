...
export default function Slider({ images }: SliderProps) {
    ...
    return (
        <div className="w-full h-full overflow-x-hidden rounded-xl animate-fade-in [animation-delay:0.8s] motion-reduce:animate-none">
            <div className="relative h-24 min-[400px]:h-full">
